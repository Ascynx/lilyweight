declare module 'lilyweight' {
    ...
    class LilyWeight {
         ...
         */
        public getWeightRaw(skillLevels: number, skillXP: number, cataCompl: number, mCataCompl: number, cataXP: number, slayerXP: number): Weights;
         ...
         */
        public getWeightFromUUID(uuid: string, returnUsername?: boolean): Promise<PlayerWeights>;
         ...
         * @returns {Promise<PlayerWeights>} The weights calculated for the player.
         */
        public getProfileWeightFromUUID (uuid: string, specifiedProfile: string, returnUsername?: boolean): Promise<PlayerWeights>;
         ...
         * @returns {Promise<PlayerWeights>} The weights calculated for the player.
         */
        public getWeightFromUsername(username: string, returnUsername?: boolean): Promise<PlayerWeights>;
         ...
         * @returns {Promise<PlayerWeights>} The weights calculated for the player.
         */
        public getProfileWeightFromUsername(username: string, specifiedProfile: string, returnUsername?: boolean): Promise<PlayerWeights>;
         ...
         * @returns {Promise<PlayerWeights>} The weights calculated for the player.
         */
        public getWeight(player: string, returnUsername?: boolean): Promise<PlayerWeights>;
         ...
         * @returns {Promise<PlayerWeights>} The weights calculated for the player.
         */
        public getProfileWeight(player: string, profile: string, returnUsername?: boolean): Promise<PlayerWeights>;
    }
}